...
\begin{example}
  ...
  \begin{center}
    \begin{tikzcd}
    1 \arrow[r,"\alpha",bend left]\arrow[r,"\beta"',bend right]&2
    \end{tikzcd}.
  \end{center}
\end{example}
\begin{example}
...
$H(X)$
\begin{itemize}
\item ホモロジー群 (ベクトル空間/$\ZZ$-加群)
\item $X$の`穴'の`個数'の情報`だけ'を持っている.
\item 扱いやすい. (データが大雑把. 大きさとかがない)
\end{itemize}

\begin{remark}
  ホモロジー群は扱いやすいが情報が落ちている.
\end{remark}
